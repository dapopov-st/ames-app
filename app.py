...
def main():
    ...
    st.text("")
    st.markdown('<p class="big-font">This app reports price prediction for homes in Ames, Iowa based on machine learning and estimates expected cap rates from student rentals based on real estate studies.</p>', unsafe_allow_html=True)
    st.text("")
